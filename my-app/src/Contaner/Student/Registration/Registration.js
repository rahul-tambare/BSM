    ...
    return (<React.Fragment >
        <form onSubmit={OnSubmit} className={classes.Form} >
            <table className={classes.Table}>
                <Table Title="Student" closeHandeler={props.change} close={props.change ? props.change : null} fields={state.Form} disabled={disabled} ss={state} fieldsInRow='4' change={(event) => onChangeHandeller(event, "Form")} />
